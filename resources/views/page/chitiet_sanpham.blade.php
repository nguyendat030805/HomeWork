            ...
            <div class="beta-sales beta-lists">
              @foreach ($splienquan as $splq )
                <div class="media beta-sales-item">
                  <a class="pull-left" href="product.html"><img src="source/source/image/product/{{$splq->images}}"
                      alt=""></a>
                  <div class="media-body">
                    <span class="beta-sales-price">{{ $splq->unit_price}}</span>
                  </div>
                </div>
              @endforeach
        ...
        <div class="widget">
          ...
          <div class="widget-body">
            <div class="beta-sales beta-lists">
                ...
                @foreach ($splienquan as $sp )
                    <div class="media beta-sales-item"></div></div>
                    <a class="pull-left" href="product.html"><img src="source/source/image/product/{{$sp->image}}"
                        alt=""></a>
                    <div class="media-body">
                      {{$sp->name}}
                      <span class="beta-sales-price">{{$sp->unit_price}}</span>
                    </div>
                  </div>
                @endforeach
